...
**/
@:native("THREE.PolyhedronGeometry") extern class PolyhedronGeometry extends BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>, BufferGeometryEventMap> {
	/**
	...
	**/
	...
	function setIndirect(indirect:Null<Dynamic>, ?indirectOffset:ts.AnyOf2<Float, Array<Float>>):PolyhedronGeometry;
	/**
