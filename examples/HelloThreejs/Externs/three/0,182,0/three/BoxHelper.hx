...
**/
@:native("THREE.BoxHelper") extern class BoxHelper extends LineSegments<BufferGeometry<haxe.DynamicAccess<ts.AnyOf2<BufferAttribute, InterleavedBufferAttribute>>, BufferGeometryEventMap>, LineBasicMaterial, Object3DEventMap> {
	/**
