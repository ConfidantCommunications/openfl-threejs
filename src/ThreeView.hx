...
/**
 * Thanks to Away3D for the original View3D implementation which this is based on.
 */
...
class ThreeView extends Sprite
{
	...
	*/
	...
	//originally a View3D constructor
	public function new(scene:Scene<Object3DEventMap>, renderer:WebGLRenderer){
	{
		super();

		//scene was Scene3D in Away3d

		//start of example from Three.js
		// var width = stage.stageWidth;
		// var height = stage.stageHeight;
		
		// init
		
		_camera = new PerspectiveCamera( 70, width / height, 0.01, 10 );
		_camera.position.z = 1;
		this._scene = scene;
		// var scene = new Scene();//THREE.Scene();
		
		
		//document.body.appendChild( renderer.domElement );

		//end of example from Three.js
		_renderer = renderer;
